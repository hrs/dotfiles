...
Rather than quitting =mu4e=, just bury the buffer.
...
- Run =elfeed-update= every five minutes, assuming Emacs has been idle for at
  least 30 seconds.
...
#+begin_src emacs-lisp
  ...
  (use-package org-appear :defer t :after org)
  (use-package org-modern :defer t :after org)
  (use-package org-superstar :defer t :after org)
