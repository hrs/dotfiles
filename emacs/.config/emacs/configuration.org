...
=company-coq-mode= adds some features (completion, documentation, ligatures...) which make Proof General a bit friendlier.

I bind the up and down arrow keys to evaluating and retracting the next and previous statements. This is more convenient for me than the default bindings of =C-c C-n= and =C-c C-u=.
