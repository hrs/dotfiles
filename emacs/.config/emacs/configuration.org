...
#+begin_src emacs-lisp
  (use-package minions
    ...
    :config
    (defun +set-minions-mode-line-lighter (_)
      (setq minions-mode-line-lighter
            (if (display-graphic-p) "⚙" "#")))

    (add-to-list 'after-make-frame-functions #'+set-minions-mode-line-lighter)
    (minions-mode 1))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (defvar +jekyll-posts-directory (expand-file-name "~/documents/blog/_drafts/"))
