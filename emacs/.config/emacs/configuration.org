...
Record the time that a todo was refiled or archived.
               ...
               '("p" "Personal agenda"
                 ((tags-todo "inbox|tickler+SCHEDULED=\"<today>\"|tickler+DEADLINE=\"<today>\""
                             ((org-agenda-overriding-header "Inbox")
                              (org-agenda-hide-tags-regexp "inbox\\|next")))

                  (tags-todo "next"
                             ((org-agenda-overriding-header "Next")
                              (org-agenda-hide-tags-regexp "habit\\|next")))
                  ...
                  (agenda ""
                          ((org-agenda-overriding-header "Calendar")
                           (org-agenda-tag-filter-preset '("-next"
                                                           "-habit"))
                           (org-agenda-hide-tags-regexp "next")))
