...
Bind some keys to summon the browser and playlist with the =M-s= prefix pair.
...
#+begin_src emacs-lisp
  ...
  (defun hrs/music-playlist ()
    (interactive)
    (switch-to-buffer " *EMMS Playlist*"))

  (global-set-key (kbd "M-s-b") 'hrs/music-browser)
  (global-set-key (kbd "M-s-<return>") 'hrs/music-playlist)
#+end_src
