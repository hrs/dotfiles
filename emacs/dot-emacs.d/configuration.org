...
** Center text to the middle of the buffer

I like to have my text centered in the middle of the buffer in certain
environments (like when writing prose, reading or editing email, or reading RSS
entries). [[https://github.com/rnkn/olivetti][Olivetti]] provides that!
...
Center content to the middle of the buffer with =olivetti-mode=.
...
I like using =olivetti-mode= to simplify my writing environment.
